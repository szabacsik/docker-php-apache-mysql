...
mv /tmp/99-php.ini /etc/php/8.0/apache2/conf.d/99-php.ini
chown root:root /etc/php/8.0/apache2/conf.d/99-php.ini
mv /tmp/99-php-cli.ini /etc/php/8.0/cli/conf.d/99-php-cli.ini
chown root:root /etc/php/8.0/cli/conf.d/99-php-cli.ini
